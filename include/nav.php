<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #353030;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse d-flex" id="navbarNavDropdown">
            ...
            <ul class="collapse navbar-collapse ml-auto p-2"id="navbarNavDropdown">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="background-color: #353030;">
