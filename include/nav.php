...
require __DIR__ . '/config.php';
 ...
 ?>
<nav class="navbar navbar-expand-lg bc-gray-black fos-3">
  ...
  <rect y="60" width="100" height="20"></rect>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active c-yellow" aria-current="page" href="<?php echo $url; ?>"><?php echo $arraytekst['home']; ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link c-yellow" href="<?php echo $url; ?>webshop.php"><?php echo $arraytekst['webshop']; ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link c-yellow" href="<?php echo $url; ?>workshop.php"><?php echo $arraytekst['workshop']; ?></a>
                </li>
            </ul>
